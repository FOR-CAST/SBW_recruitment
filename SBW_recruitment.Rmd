...
subtitle: "v.`r SpaDES.core::moduleMetadata(module = 'SBW_recruitment', path = '..')$version`"
...
```{r setup-SBW-recruitment, include=FALSE}
...
`r paste(as.character(SpaDES.core::moduleMetadata(module = "SBW_recruitment", path = '..')$authors), sep = ', ')`
...
```{r moduleInputs-SBW-recruitment, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_inputs <- SpaDES.core::moduleInputs("SBW_recruitment", "/home/achubaty/Documents/GitHub/FOR-CAST/SBW_EasternBoreal/modules")
knitr::kable(df_inputs,
             caption = "List of (ref:SBW-recruitment) input objects and their description.") |>
...
```{r moduleParams-SBW-recruitment, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_params <- SpaDES.core::moduleParams("SBW_recruitment", "/home/achubaty/Documents/GitHub/FOR-CAST/SBW_EasternBoreal/modules")
knitr::kable(df_params, caption = "List of (ref:SBW-recruitment) parameters and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
...
```{r moduleOutputs-SBW-recruitment, echo = FALSE, eval = TRUE, message = FALSE, warning = FALSE}
df_outputs <- SpaDES.core::moduleOutputs("SBW_recruitment", "/home/achubaty/Documents/GitHub/FOR-CAST/SBW_EasternBoreal/modules")
knitr::kable(df_outputs, caption = "List of (ref:SBW-recruitment) outputs and their description.") |>
  kableExtra::kable_styling(latex_options = "scale_down", full_width = TRUE)
```
